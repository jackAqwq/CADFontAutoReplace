...
internal static partial class MTextSyntaxHighlighter
{
...
#else
    private static readonly Regex _formatCodeRegex = new(FormatCodePattern, RegexOptions.Compiled);
    internal static Regex FormatCodeRegex() => _formatCodeRegex;
#endif
    ...
    public static FlowDocument CreateHighlightedRawDocument(string displayContents)
    {
        ...
        {
            FontFamily = new FontFamily("JetBrains Maple Mono, Cascadia Code, Consolas"),
            FontSize = 13,
