...
**注1：本插件并不会主动关闭图纸打开时选择缺失字体的对话框，如果要使用本插件，建议CAD弹出缺少SHX文件对话框时选择`忽略缺少的SHX文件并继续`并勾选`始终执行我的当前选择`。**
...
**注2：如果不知道选择那个字体则建议使用`yjkeng.shx`做为SHX字体，`tssdchn.shx`作为大字体（字体已打包到可以在发布页中下载）。**
